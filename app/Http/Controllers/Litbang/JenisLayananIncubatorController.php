...
//            })
    ...
    public function create(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($result->count()) {
                ...
                DB::commit();
                return $this->respondCreated($result, 'Jenis Layanan Berhasil Ditambahkan!');
            } else {
                DB::rollBack();
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($result) {
                DB::commit();
                return $this->respondCreated($result, 'Jenis Layanan Berhasil Diupdate!');
            } else {
                DB::rollBack();
    ...
    public function delete(Request $request)
    {
        ...
        if ($result) {
            return $this->respondOk('Jenis Layanan Berhasil Dihapus!');
        } else {
